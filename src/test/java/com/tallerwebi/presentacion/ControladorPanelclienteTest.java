...
public class ControladorPanelclienteTest {
    ...
    public void init() {
        ...
        controlador = new ControladorPanelcliente(
                servicioUsuarioMock,
    ...
    public void irAPanelDatosPersonalesConUsuarioLogueadoSinPerfilAlimentarioRedirigeARegistroPerfil() {
        ...
        // Then
        assertThat(modelAndView.getViewName(), equalToIgnoringCase("redirect:/Registro-perfil-alimentario"));
    }
    ...
    public void irADespensaConUsuarioLogueadoYDespensaConElementosMuestraVistaConModeloCorrecto() {
        ...
        assertThat(modelAndView.getModel().get("listaAlimentosBaseDatos"), is(sameInstance(alimentosFake)));
        assertThat(modelAndView.getModel().get("itemDespensaDTO"), is(instanceOf(ItemDespensaDTO.class)));
    }
