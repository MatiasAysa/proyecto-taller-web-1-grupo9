...
public class ServicioListaComprasTest {
  ...
  RepositorioListaDeComprasImpl repositorioListaDeCompras;
  ServicioListaCompras servicioListaCompras;

  @BeforeEach
  public void iniciazarObjetos() {
    repositorioListaDeCompras = mock(RepositorioListaDeComprasImpl.class);
    servicioListaCompras = new ServicioListaComprasImpl(repositorioListaDeCompras);
  }
